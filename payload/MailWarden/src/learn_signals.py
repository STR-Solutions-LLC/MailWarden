...
def handle_new_pattern(classification: dict, example: dict,
    ...
    body = (
        ...
        f"IMPORTANT: Just reply normally. MailWarden picks up your answer "
        f"on its next tick whether or not the reply has been read -- you "
        f"don't need to keep it unread.\n\n"
